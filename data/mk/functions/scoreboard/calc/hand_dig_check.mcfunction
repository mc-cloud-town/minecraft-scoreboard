execute store result score var.x mk.match.integer run data get entity @s Pos[0]
# execute store result score var.y mk.match.integer run data get entity @s Pos[1]
execute store result score var.z mk.match.integer run data get entity @s Pos[2]
